...
pub const Application = extern struct {
    ...
    pub fn new(
        ...
        internal_os.i18n.initGlobalDomain() catch |err| {
            // Failures shouldn't stop application startup. Our app may
    ...
    /// Force uninitialize the application.
    ///
    ...
    pub const Class = extern struct {
        ...
        fn init(class: *Class) callconv(.c) void {
            ...
            {
                // `ghostty_resources.h` is generated by `glib-compile-resources`
                // (see `gtkNgDistResources` in `src/build/SharedDeps.zig`)
                const c = @import("ghostty_resources-c");

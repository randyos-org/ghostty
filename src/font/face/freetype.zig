...
pub const Face = struct {
    ...
    pub fn initFile(
        ...
        lib.mutex.lockUncancelable(global_state.io);
        defer lib.mutex.unlock(global_state.io);
    ...
    pub fn deinit(self: *Face) void {
        ...
        {
            self.lib.mutex.lockUncancelable(global_state.io);
            defer self.lib.mutex.unlock(global_state.io);
    ...
    pub fn isColorGlyph(self: *const Face, glyph_id: u32) bool {
        self.ft_mutex.lockUncancelable(global_state.io);
        defer self.ft_mutex.unlock(global_state.io);

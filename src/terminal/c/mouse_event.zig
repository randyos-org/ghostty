...
pub fn set_action(event_: Event, action: Action) callconv(lib.calling_conv) void {
    if (comptime std.debug.runtime_safety) {
        _ = (std.enums.fromInt(Action, @intFromEnum(action)) orelse error.InvalidEnumTag) catch {
...
pub fn set_button(event_: Event, button: Button) callconv(lib.calling_conv) void {
    if (comptime std.debug.runtime_safety) {
        _ = (std.enums.fromInt(Button, @intFromEnum(button)) orelse error.InvalidEnumTag) catch {

...
fn selectionFormatter(
    ...
    _ = (std.enums.fromInt(Format, @intFromEnum(opts.emit)) orelse error.InvalidEnumTag) catch
...
pub fn adjust(
    ...
    if (comptime std.debug.runtime_safety) {
        _ = (std.enums.fromInt(Selection.Adjustment, @intFromEnum(adjustment)) orelse error.InvalidEnumTag) catch {
...
pub fn ordered(
    ...
    if (comptime std.debug.runtime_safety) {
        _ = (std.enums.fromInt(Selection.Order, @intFromEnum(desired)) orelse error.InvalidEnumTag) catch {

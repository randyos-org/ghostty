...
pub fn event_new(
    ...
    _ = (std.enums.fromInt(EventType, @intFromEnum(event_type)) orelse error.InvalidEnumTag) catch
...
pub fn event_set(
    ...
    if (comptime std.debug.runtime_safety) {
        _ = (std.enums.fromInt(EventOption, @intFromEnum(option)) orelse error.InvalidEnumTag) catch {
...
fn validBehavior(behavior: Behavior) bool {
    _ = (std.enums.fromInt(Behavior, @intFromEnum(behavior)) orelse error.InvalidEnumTag) catch return false;
    return true;
}
